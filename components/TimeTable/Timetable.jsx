...
function Timetable() {
  return (
    <div className="flex flex-col items-center pt-52 md:pt-36 2xl:pt-32 mx-11 md:mx-24 2xl:mx-36 pb-64 md:pb-32 2xl:pb-56 text-center text-[#F2F2F2] ">
      ...
      <div className="h-[560px] max-w-[1200px] w-full mx-4 md:mx-20 2xl:mx-28 bg-sky-200">
        <div className="h-[160px] w-full bg-amber-300 text-black">
          เกาะ
          <hr className="my-10 mx-10 border-2 border-dashed border-white"></hr>
        </div>
